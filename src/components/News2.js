...
async updateNews(){
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=6b9778e89d0740f0b5edf43eaec8114c&page=1&pageSize=${this.props.pageSize}`;
...
fetchMoreData = async () => {
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=6b9778e89d0740f0b5edf43eaec8114c&page=${this.state.page+1}&pageSize=${this.props.pageSize}`;
